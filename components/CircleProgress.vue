<!-- Code from https://github.com/delowardev/vue3-circle-progress/blob/main/src/components/CircleProgress.vue -->
<template>
        ...
        <svg v-bind="svgAttr">
            ...
            <template v-if="isShadow">
                ...
                <filter v-else v-bind="shadowAttr">
                    ...
                    <feFlood :flood-color="feShadowAttr.floodColor" :flood-opacity="feShadowAttr.floodOpacity"
                        result="color" />
            ...
            <template v-if="bgShadow">
                ...
                <filter v-else v-bind="bgShadowAttr">
                    ...
                    <feComposite operator="out" in="SourceGraphic" result="inverse" />
                    <feFlood :floodColor="feBgShadowAttr.floodColor" :floodOpacity="feBgShadowAttr.floodOpacity"
                        result="color" />
                    <feComposite operator="in" in="color" in2="inverse" result="shadow" />
                    <feComposite operator="over" in="shadow" in2="SourceGraphic" />
                </filter>
